...
public class Client extends JFrame implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(o == button)//닉네임 입력부분
		{
			...
			{ 
				area.append("※불법스포츠 도박은 벌금형 또는 징역형을 받을수있습니다.※");
				area.append("\n");
				area.append("※합법적인 사이트를 이용합시다.!!※");
				area.append("\n");
				area.append("※과한 도박은 가족을 잃을 수도 있습니다.※");
				area.append("\n");
				area.append("한국도박문제 관리센터 : 국번없이 1336(24시간)");
				area.append("\n");
				area.append("KL중독관리센터 : 전화상담 080-7575-545");
				area.append("\n");
				area.append("-----"+getTime()+" 접속완료    닉네임 : " + input_ID.getText()+"-----"); // 입력한 경우 서버로 id값을 보내게 설정.
				area.append("\n");
				area.append("※라이브스코어에 오신것을 환영합니다.※");
				area.append("\n");
				input_ID.setText("");
